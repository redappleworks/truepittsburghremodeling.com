...
export const BUSINESS_NAME = "True Pittsburgh Remodeling";
export const BUSINESS_PHONE = "(555) 123-4567";
export const BUSINESS_EMAIL = "contact@truepittsburghremodeling.com";
...
export const CONTACT_FROM_EMAIL = "True Pittsburgh Remodeling <contact@redappleworks.com>";
...
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://truepittsburghremodeling.com";

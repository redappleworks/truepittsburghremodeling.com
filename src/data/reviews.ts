...
export const reviews: Review[] = [
    {
        ...
        location: "Mt. Lebanon",
        rating: 5,
        text: "Aspen Remodeling transformed our outdated kitchen into a modern masterpiece. The team was professional, clean, and finished on schedule. We couldn't be happier with the results!",
        projectType: "Kitchen",
        date: "2024-11",
        featured: true,
    },
    ...
    },
    {
        ...
        location: "Dormont",
        rating: 5,
        text: "Aspen Remodeling did an incredible job with our small bathroom. They maximized every inch of space and the design suggestions were spot on.",
        projectType: "Bathroom",
        date: "2024-05",
        featured: false,
    },
